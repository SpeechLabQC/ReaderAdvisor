...
public class InstallationWorker extends SwingWorker<Integer,String> {
    ...
    private final Vector<String> filesToSkip;
    ...
    public InstallationWorker(
            ...
            final Vector<String> filesToSkip
    ){
    ...
    protected Integer doInBackground() throws Exception {
        ...
        // Skip files
        for(String ext : filesToSkip){
            uncompressZipFile.addExtensionSkipFilter(ext);
        }
        uncompressZipFile.init();
